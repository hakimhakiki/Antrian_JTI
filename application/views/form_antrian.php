...
<html lang="en">
  ...
  <body>
    <div class="wrapper">
      ...
      <form class="middle" id="form-antrian" action="" method="POST">
        <div class="row">
          <div class="col-md-6">
            ...
            <div class="form-group">
              <label for="keperluan">Keperluan ke</label>
            ...
            <div class="form-group">
              ...
              <select class="form-control" id="prodi">
                ...
                <option value="inter">MIF/TIF International</option>
              </select>
            </div>
          </div>
          <div class="col-md-6">
